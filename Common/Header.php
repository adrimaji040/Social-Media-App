...
<body class="d-flex flex-column min-vh-100">
    ...
    <div class="position-fixed end-0 mt-5 me-3 px-3 py-2 rounded-pill shadow security-badge
    <?= $SECURITY_MODE === 'secure' ? 'bg-success' : 'bg-danger' ?> text-white fw-bold"
        style="z-index: 1050; top: 70px; border: 2px solid rgba(255,255,255,0.3);" title="Current Security Mode">
        <i class="fas <?= $SECURITY_MODE === 'secure' ? 'fa-shield-alt' : 'fa-exclamation-triangle' ?>"></i>
